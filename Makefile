...
run-migrations:
	liquibase --changeLogFile=db-changelog.xml  --driver=org.postgresql.Driver --url=jdbc:postgresql://localhost:5432/attendance_db  --username=postgres --password=password  update
